                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ URL::asset('/images/image-4.jpeg') }}"
                                                                            alt="" title=""
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <h2
                                                                style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: arial,helvetica,sans-serif; font-size: 20px;">
                                                                votre de demande de
                                                                reservation
                                                            </h2>
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://twitter.com/lidem"
                                                                                        title="Twitter" target="_blank">
                                                                                        <img src="{{ URL::asset('/images/image-1.png') }}"
                                                                                            alt="Twitter"
                                                                    ...
                                                                    <table align="left" border="0" cellspacing="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="https://facebook.com/lidem"
                                                                                        title="Facebook"
                                                                                        target="_blank">
                                                                                        <img src="{{ URL::asset('/images/image-2.png') }}"
                                                                                            alt="Facebook"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://discordapp.com/"
                                                                                        ...
                                                                                        <img src="{{ URL::asset('/images/image-5.png') }}"
                                                                                            alt="Discord"
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://reddit.com/"
                                                                                        ...
                                                                                        <img src="{{ URL::asset('/images/image-3.png') }}"
                                                                                            alt="Reddit" title="Reddit"
                                                                                            width="32"
                                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                                                    </a>
                                                                                </td>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div>
                                                                <ul>
                                                                    <li>
                                                                        <a href="https://lidem.eu">lidem.eu</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="https://goo.gl/maps/7dVt2MMJu2iGoYwp8">50
                                                                            Rue Pierre Semard, 66270 Le
                                                                            Soler</a>
                                                                    </li>
                                                                    <li>
                                                                        04 68 92 53 84
